...
#define MOTOR_FORWARD_PIN_1 1
#define MOTOR_REWIND_PIN_1 2
#define MOTOR_FORWARD_PIN_2 3
#define MOTOR_REWIND_PIN_2 4
#define MOTOR_FORWARD_PIN_3 5
#define MOTOR_REWIND_PIN_3 6
#define MOTOR_FORWARD_PIN_4 7
#define MOTOR_REWIND_PIN_4 8
#define MOTOR_FORWARD_PIN_5 9
#define MOTOR_REWIND_PIN_5 10
